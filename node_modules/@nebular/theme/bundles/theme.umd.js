...
var NbTriggerStrategyBase = /** @class */ (function () {
    ...
    NbTriggerStrategyBase.prototype.isElementInBody = function (element) {
        return this.document.body.contains(element);
    };
    NbTriggerStrategyBase.prototype.isHostInBody = function () {
...
var NbDynamicOverlayHandler = /** @class */ (function () {
    ...
    NbDynamicOverlayHandler.prototype.subscribeOnTriggers = function (dynamicOverlay) {
        var triggerStrategy = this.triggerStrategyBuilder
            .trigger(this._trigger)
            .host(this._host.nativeElement)
            .container(function () { return dynamicOverlay.getContainer(); })
            .build();
        triggerStrategy.show$.pipe(rxjs_operators.takeUntil(this.disconnect$))
            .subscribe(function () { return dynamicOverlay.show(); });
        triggerStrategy.hide$.pipe(rxjs_operators.takeUntil(this.disconnect$))
            .subscribe(function () { return dynamicOverlay.hide(); });
    };
